        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {services.map((service) => (
              ...
              >
                <span className="inline-flex h-16 w-16 items-center justify-center rounded-xl border border-slate-200 bg-slate-100 text-slate-500 shadow-sm shadow-slate-400/10 transition-colors group-hover:border-sun/60 group-hover:bg-sun-tint group-hover:text-sun-deep">
