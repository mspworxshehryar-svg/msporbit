    ...
    <div>
      <section className="border-b border-white/10 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <p className="text-sm font-medium text-sky-400">What We Do</p>
          <h1 className="mt-3 text-4xl font-bold text-white sm:text-5xl">Our Services</h1>
          ...
          {services.map((service, i) => (
            ...
            >
              <div>
                ...
                <h2 className="mt-2 text-2xl font-bold text-white">{service.name}</h2>
      ...
      <section className="border-t border-white/10 bg-[#0e1526] py-20">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <h2 className="text-3xl font-bold text-white">Not sure which services you need?</h2>
